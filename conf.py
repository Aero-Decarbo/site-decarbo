...
BLOG_AUTHOR = "Aéro Décarbo"  # (translatable)
BLOG_TITLE = "Aéro Décarbo"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://decarbo.org/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://decarbo.org/"
BLOG_EMAIL = "contact@decarbo.org"
BLOG_DESCRIPTION = "Le site de l'association Aéro Décarbo"  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/media.html',  "Dans les media"),
        ("/voir_ailleurs.html",  "Voir ailleurs"),
        ((("/histoire.html",  "Notre histoire"),
          ("/engagement.html", "Notre engagement"),
    ...
    "en": (
        ...
        ('/en/media.html',  "In the media"),
        ("/en/voir_ailleurs.html",  "Look elsewhere"),
        ((("/en/history.html",  "Our history"),
          ("/en/commitment.html", "Our commitment"),
          ('/en/values.html',   "Our values"),
...
LOGO_URL = '/images/logo AD header.png'
...
#CONTENT_FOOTER = '<a href="/mentions-legales.html">Mentions légales</a>'
...
SOCIAL_LINKS = {
    "Linkedin": "https://www.linkedin.com/company/aero-decarbo/",
    "Facebook": "https://www.facebook.com/aerodecarbo"
}
