...
.. raw:: html
   ...
   <a href="https://theshiftproject.org" target="_blank" ><i>The Shift Project</i></a> and the Supaéro Décarbo collective (ancestor of the Aéro Décarbo association) published their new report on decarbonization of the aviation sector, "Flying in 2050: Which aviation in a constrained world?" on Wednesday, March 3, 2021. This report followed the Shift Project's initial work on the subject with the May 2020 publication of "Crisis(-es), climate: preparing the future of aviation."
   </div>
